...
public class WeatherApp {
    static final String help_document = ""
        ...
        + "--search or -s {string} [{nation}]:    \t\tsearch available city names begin with {string} in country {nation}";
     ...
     */
    @SuppressWarnings("unchecked") static ArrayList<String> loadFavoriteList() {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length == 0) {
            ...
            if (args.length == 1 && parser.isArgDetail()) {
                if (favoriteList.isEmpty()) {
                    System.out
                        .println("favorite list is empty. \nuse --add to add city into the list.");
                } else {
                    for (String city : favoriteList) {
                        try {
                            ...
                            System.out
                                .println("Exceed the call limit of the openweathermap api id");
                        }
                    }
                }
            } else {
                ...
                if (parser.getAddCities() != null) {
                    ...
                    for (String city : parser.getAddCities()) {
                        ...
                        if (!favoriteList.contains(city)) {
                            ...
                            System.out
                                .println("city \"" + city + "\" already in the favorite list");
                        }
                    }
                }
                if (parser.getRemoveCities() != null) {
                    for (String city : parser.getRemoveCities()) {
                        if (!favoriteList.remove(city)) {
                            System.out
                                .println("city \"" + city + "\" does not in the favorite list");
                        }
                    }
                }
                if (parser.isArgList()) {
                ...
                if (parser.getSearchCity() != null) {
                    ...
                    if (parser.getSearchCityNation() != null) {
                        iter = cityNameList
                            .search(parser.getSearchCity(), parser.getSearchCityNation());
                    } else {
